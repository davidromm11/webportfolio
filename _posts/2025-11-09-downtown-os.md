...
The 8088 is obsolete, but the ideas persist. Every OS has a bootloader, memory allocation, file systems, screen management, and system calls. DownTownOS strips away all of the fancy advancements and demonstrates pure, essential concepts.

## The Limitations Are Features

DownTownOS has many limitations. No multitasking, any program can crash the system, no networking, tiny files, tiny disk, and no GUI. Each of these features multiplies complexity. DownTownOS stays simple by staying minimal.

## Running It Today

You can boot DownTownOS in Bochs, VirtualBox, or even real hardware if you have an old PC and floppy drive. The `disk0.img` file is a complete system. Boot from it, and you have a working OS with file system, shell, and text editor.
